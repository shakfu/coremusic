...
class Clip:
    ...
    def __init__(self, source: str | Path | MIDIClip | Any, clip_type: str = "audio"):
        ...
        self.duration: float | None = None  # None = full file
        self.fade_in = 0.0
        self.fade_out = 0.0
...
class Timeline:
    ...
    def __init__(self, sample_rate: float = 44100.0, tempo: float = 120.0):
        ...
        self.loop_region: TimeRange | None = None
        self._playhead = 0.0
        self._is_playing = False
        self._is_recording = False
        self._link_session: Any | None = None
    ...
    def play(self, from_time: float | None = None) -> None:
        """Start playback.
    ...
    def record(self, armed_tracks: list[Track] | None = None) -> None:
