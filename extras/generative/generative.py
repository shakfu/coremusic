...
class ArpConfig(GeneratorConfig):
    ...
    latch: bool = False
    velocity_pattern: list[int] | None = None
...
class MarkovGenerator(Generator):
    ...
    def _get_next_note(self, current: int) -> int | None:
...
class SequenceGenerator(Generator):
    ...
    def __init__(
        ...
        self._steps: list[Step | None] = [None] * steps
    ...
    def set_pattern(self, pattern: list[int | None], velocity: int = 100) -> None:
...
class MelodyGenerator(Generator):
    ...
    def _get_next_note(self, current: int, direction_hint: int = 0) -> int:
        ...
        candidates = []
        candidate_weights = []
        for step, weight in zip(range(-max_step, max_step + 1), weights, strict=True):
...
class PolyrhythmGenerator(Generator):
    ...
    def __init__(
        ...
        config: PolyrhythmConfig | None = None,
    ):
...
class BitShiftRegisterConfig(GeneratorConfig):
    ...
    duration_pattern: list[float] | None = None
...
class BitShiftRegister:
    ...
    def __init__(self, size: int, initial_state: list[int] | None = None):
    ...
    def reset(self, pattern: list[int] | None = None) -> None:
        """Reset the register.
...
class BitShiftRegisterGenerator(Generator):
    ...
    def __init__(
        self,
        size: int = 4,
        pitches: list[int | Note] | None = None,
        initial_state: list[int] | None = None,
        config: BitShiftRegisterConfig | None = None,
    ):
    ...
    def set_pitches(self, pitches: list[int | Note]) -> None:
    ...
    def generate(  # type: ignore[override]
        self,
        gate_inputs: list[int] | None = None,
