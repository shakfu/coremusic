...
class CPT:
    ...
    def __init__(
        ...
        self._probs_cache: dict[tuple[int, ...], dict[int, float]] | None = None
...
class BayesianNetwork:
    ...
    def get_entropy(
        self, variable: str, evidence: dict[str, int] | None = None
    ) -> float:
    ...
    @classmethod
    def load(cls, filepath: str | Path) -> BayesianNetwork:
...
def merge_networks(
    ...
    for var in merged._variables:
        ...
        for network, weight in zip(networks, weights, strict=True):
