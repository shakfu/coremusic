...
# The modules under test are not part of the installed package; they live in
# extras/ and are imported from there.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent / "extras"))
...
class TestMIDIFileGeneration:
    ...
    def test_generate_sequence_melodic(self):
        ...
        for i, (pitch, vel) in enumerate(zip(pitches, velocities, strict=True)):
