...
class AudioRingBuffer:
    ...
    def __init__(self, frames: int = 8192, channels: int = 2) -> None: ...
    def available(self) -> int: ...
    def push_floats(self, data: Any) -> int: ...
    def push_bytes(self, data: Any) -> int: ...
    def pop_into(self, out: Any) -> int: ...
    @property
...
class AudioOutputStreamImpl:
    ...
    def setup_direct(
        self, ring: AudioRingBuffer, sample_rate: float = 44100.0, channels: int = 2
    ) -> None: ...
    def start(self) -> None: ...
    def stop(self) -> None: ...
    def close(self) -> None: ...
...
class AudioInputStreamImpl:
    """Callback-driven real-time audio input (capture) stream."""
    def __init__(self) -> None: ...
    def setup(
        self,
        callback: Any,
