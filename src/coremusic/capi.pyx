...
# =============================================================================
# High-performance audio processing functions using Cython optimizations:
# - Typed memoryviews for C-speed array access
# - nogil operations for parallel processing
...
def normalize_audio(audio_data, float target_peak=0.9):
    ...
    Example:
        ...
        >>> normalized = cm.normalize_audio(audio, target_peak=0.8)
    """
    import numpy as np
...
def apply_gain(audio_data, float gain_db):
    ...
    Example:
        ...
        >>> import coremusic as cm
        >>> audio = np.random.randn(44100, 2).astype(np.float32)
        >>> louder = cm.apply_gain(audio, gain_db=6.0)  # +6dB
    """
    import numpy as np
